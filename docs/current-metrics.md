...
|---|---:|---|
| PHPUnit tests | 222 tests | `composer test:ut` |
| PHPUnit assertions | 1,540 assertions | `composer test:ut` |
...
| Test PHP lines (`tests/phpunit/`) | 5,147 | `find ./tests/phpunit -type f -name "*.php" -print0 \| xargs -0 wc -l \| tail -1` |
...
| Test-to-production ratio (PHP) | 1.89:1 | `5147 / 2730` |
...
- `composer test:ut` passed on 2026-03-15 (222 tests, 1540 assertions).
